...
try:
    ...
    print(
        "Unable to lock file: " + xmodmap + ". Maybe another instance already running"
    )
    sys.exit(1)
...
def get_current_session_path():
    seat = system_bus.get_object(
        "org.freedesktop.login1",
        "/org/freedesktop/login1/seat/" + os.environ["XDG_SEAT"],
    )
    active_session = seat.Get(
